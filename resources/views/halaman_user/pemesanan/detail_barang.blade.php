                                     ...
                                     <div class="itemtype" style="margin-bottom: 40px">
                                         <div class="row">
                                           <div class="itemtype">
                                               ...
                                               <div class="col-md-4"> <p class="p-price float-left">Kuantiti </p><input type="number" name="kuantiti" min="1" class="form-control"></div>
                                               <div class="col-md-4"></div>
					...
					<div class="fh5co-tabs animate-box">
						...
						<div class="fh5co-tab-content-wrap">
							...
							<div class="fh5co-tab-content tab-content active" data-tab-content="1">
								<div class="col-md-10 col-md-offset-1">
									<span class="price">Rp. {{ number_format($detail->persediaan->harga) }}</span>
									<h2>{{ $detail->nama_barang }}</h2>
